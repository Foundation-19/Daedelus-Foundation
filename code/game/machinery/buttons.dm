/obj/machinery/button
	...
	armor = /datum/armor/machinery_button
...
/obj/machinery/button/update_appearance()
	...
	if(panel_open || (machine_stat & (NOPOWER|BROKEN)))
		...
		set_light(initial(light_outer_range), light_power, light_color)
...
/obj/machinery/button/attackby(mob/living/user, obj/item/tool, list/modifiers)
	if(!panel_open)
		return NONE
